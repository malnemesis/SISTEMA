...
require_once "../modelos/Consultas.php";
  ...
  $compras30 = $consulta->comprasultimos_30dias();
  $fechasc='';
  $totalesc='';
  while ($regfechac= $compras30->fetch_object()) {
  ...
  $ventas30 = $consulta->ventasultimos_30dias();
  $fechasv='';
  $totalesv='';
  while ($regfechav= $ventas30->fetch_object()) {
